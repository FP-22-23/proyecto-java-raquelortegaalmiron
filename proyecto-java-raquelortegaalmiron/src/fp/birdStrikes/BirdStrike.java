...
import src.fp.utiles.Checkers;

public class BirdStrike implements Comparable <BirdStrike>{

	//Atributos
	private	String name;
	private String altitudebin; //<1000 ft
	...
	//Constructores
	public BirdStrike(String name, String altitudebin, String model, String impactFlight, LocalDate flightDate,
			Integer recordID, IndicatedDamage indicatedDamage, Integer numberEngines, String airline,
			String originState, String whenPhaseFlight, Size size, String species, Integer when, YesNo pilotWarned,
	...
	public String getAltitudebin() {
		return altitudebin;
	}

	public void setAltitudebin(String altitudebin) {
		this.altitudebin = altitudebin;
	}
	...
	public YesNo getPilotWarned() {
		return pilotWarned;
	}

	public void setPilotWarned(YesNo pilotWarned) {
		this.pilotWarned = pilotWarned;
	}
	...
	public String toString() {
		return "BirdStrikes [name=" + name + ", altitudebin=" + altitudebin + ", model=" + model + ", impactFlight="
	...
	private boolean formateoPilotWarned(YesNo pilotWarned) {
		String res = null;
				switch(pilotWarned) {
				case Y:
					res = "true";
